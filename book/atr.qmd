...
abstract: > 
  Demystifying the process behind automatic text recognition and offering practical tips on how anyone can get started in their own library.
keywords:
...
The blog by FromThePage is a good source on everything on GenAI and ATR and how the landscape is changing (https://content.fromthepage.com/).
